...
export default function ElectionHeader() {
	...
	const [top, setTop] = useState([
		...
		'',
		'',
		'Basically, I have my own app on the appstore. B/c of this, I’m forced to exercise leadership and business skills every single day.',
		'',
		`Some of you are familiar with my craft. If not, you be will during my speech. Who better to trust Raven Time. than someone who works with media every day? I’ll let my work speak for itself tomorrow :)`,
		'',
		`One thing I’m known for is saying something incredibly outlandish or crazy, and then following through with it. (i.e. hanging up a massive QR codes in the hallway). We need someone bold and willing to take risks`,
